...
class SaveJsonAgent(ConnectedAgent):
    ...
    def __init__(self, config: SaveJsonAgentConfig, **kwargs) -> None:
        """
    ...
    def process(self, params: BaseIOSchema, parents: List[str], unique_id:str = None) -> BaseIOSchema:
        ...
        """
        return self.run_parents(params, parents, unique_id)

    def run_parents(self, params: BaseModel, parents: List[str], unique_id:str = None) -> BaseModel:
        """
