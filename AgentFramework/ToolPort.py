...
class ToolPort:
    ...
    def __init__(self, direction: Direction, model: Type[BaseModel]) -> None:
        """
    ...
    def connect(self, target_port: "ToolPort",
        ...
        self.connections.append((target_port, transformer))
    ...
    def send(self, message: BaseModel, parents: List[str]) -> None:
        ...
        if self.connections:
            ...
            for target_port, transformer in self.connections:
